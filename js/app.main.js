  ...
  createApp({
    setup() {
      ...
      return {
        ...
        availableDungeonsForFilter: state.availableDungeonsForFilter,
        recommendationDungeonIds: state.recommendationDungeonIds,
        toggleDungeonFilter: state.toggleDungeonFilter,
        isDungeonFilterActive: state.isDungeonFilterActive,
